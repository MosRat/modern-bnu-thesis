...
#abstract(keywords: ("我", "就是", "测试用", "关键词"))[
  #indent 摘要是学位论文的内容不加注释和评论的简要陈述。摘要应具有独立性和自含性，即不阅读论文的全文，就能获得必要的信息。摘要一般应说明研究工作的目的、方法、结果和结论等，应突出论文的创新点。
  
  #indent 博士学位论文的摘要一般 2000 字左右，硕士学位论文的摘要一般1000 字左右。摘要中应尽量避免采用图、表、化学结构式、非公知公用的符号和术语。英文摘要的内容应与中文摘要相对应。
